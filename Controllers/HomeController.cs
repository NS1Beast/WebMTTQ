...
public class HomeController : Controller
{
    ...
    private static HomePageViewModel BuildHomePage() => new()
    {
        ...
        [
            ...
            new NewsItem
            {
                Title = "TRỢ LÝ AI PHƯỜNG TÂN ĐỊNH – TRA CỨU THÔNG TIN NHANH CHÓNG, CHÍNH XÁC",
                Url = "#",
        ...
        [
            new NewsCategoryBlock
            {
                ...
                ListItems =
                [
                    new() { Title = "Công tác hỗ trợ đột xuất từ Quỹ \"Vì người nghèo\" PHƯỜNG TÂN ĐỊNH", Url = "#", Date = "14/06/2026" },
            ...
            new NewsCategoryBlock
            {
                ...
                Featured = new FeaturedNewsItem
                {
                    Title = "THÔNG BÁO NHÂN SỰ BÍ THƯ CHI BỘ, PHÓ BÍ THƯ/TRƯỞNG ẤP TRÊN ĐỊA BÀN PHƯỜNG TÂN ĐỊNH (SAU SÁP NHẬP)",
                    Url = "#",
                ...
                [
                    ...
                    new() { Title = "ĐẢNG ỦY CÁC CƠ QUAN ĐẢNG PHƯỜNG TÂN ĐỊNH SƠ KẾT CÔNG TÁC XÂY DỰNG ĐẢNG", Url = "#", Date = "07/07/2026" },
        ...
        Timeline =
        [
            new() { Date = "12/8/2025", Title = "Bản đồ số PHƯỜNG TÂN ĐỊNH", Description = "Số hóa địa giới, trụ sở và các điểm quan trọng trên nền bản đồ tương tác." },
            new() { Date = "11/9/2025", Title = "Zalo OA Mặt trận PHƯỜNG TÂN ĐỊNH", Description = "Kênh Zalo chính thức kết nối, đưa thông tin nhanh đến người dân." },
            ...
            new() { Date = "26/10/2025", Title = "Trang thông tin Mặt trận PHƯỜNG TÂN ĐỊNH", Description = "Cổng thông tin điện tử công khai văn bản và hoạt động của Mặt trận." },
            ...
            new() { Date = "26/3/2026", Title = "Thư viện số PHƯỜNG TÂN ĐỊNH", Description = "Kho sách, tài liệu số phục vụ học tập và tra cứu của người dân." },
            ...
            new() { Date = "Dự kiến · 7/2026", Title = "Mini app Mặt trận PHƯỜNG TÂN ĐỊNH", Description = "Ứng dụng trên Zalo tích hợp toàn bộ tiện ích số của xã trong một chạm.", IsNext = true }
        ],
        Stats =
        [
